...
del properties2016, properties2017, train2016, train2017, test_df
gc.collect();
...
ESTIMATORS = [
            ...
            CatBoostRegressor(iterations=630, learning_rate=0.03,depth=6, l2_leaf_reg=3,loss_function='MAE',eval_metric='MAE',random_seed=5),
...
def cross_validation(all_df, folds = 10):
